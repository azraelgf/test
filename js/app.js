(() => {
    ...
    function initSliders() {
        if (document.querySelector(".tariffs__body")) new swiper_core_Swiper(".tariffs__body", {
            ...
            on: {
                init: function(swiper) {
                    const curSlide = +document.querySelector(".swiper-pagination-current").textContent, totalSlide = +document.querySelector(".swiper-pagination-total").textContent, bar = document.querySelector(".bar");
                    if (totalSlide > 1) barProgress(curSlide, totalSlide, bar);
                },
                slideChange: function(swiper) {
                    const curSlide = +document.querySelector(".swiper-pagination-current").textContent, totalSlide = +document.querySelector(".swiper-pagination-total").textContent, bar = document.querySelector(".bar");
                    barProgress(curSlide, totalSlide, bar);
                }
            }
        });
    }
    function barProgress(curSlide, totalSlide, bar) {
        let barWidth;
        barWidth = curSlide / totalSlide * 100;
